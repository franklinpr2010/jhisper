package br.gov.susep.repository;

import br.gov.susep.RfbloyaltApp;

import br.gov.susep.config.Constants;
import br.gov.susep.config.audit.AuditEventConverter;
import br.gov.susep.domain.PersistentAuditEvent;
...
import static br.gov.susep.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
