package br.gov.susep.web.rest;

import br.gov.susep.RfbloyaltApp;
import br.gov.susep.config.Constants;
import br.gov.susep.domain.PersistentToken;
import br.gov.susep.domain.User;
import br.gov.susep.repository.AuthorityRepository;
import br.gov.susep.repository.PersistentTokenRepository;
import br.gov.susep.repository.UserRepository;
import br.gov.susep.security.AuthoritiesConstants;
import br.gov.susep.service.UserService;
import br.gov.susep.service.dto.PasswordChangeDTO;
import br.gov.susep.service.dto.UserDTO;
import br.gov.susep.web.rest.vm.KeyAndPasswordVM;
import br.gov.susep.web.rest.vm.ManagedUserVM;
...
import static br.gov.susep.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
@SpringBootTest(classes = RfbloyaltApp.class)
